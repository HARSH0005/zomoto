...
function SearchPageResult() {
  ...
  let [restaurantList,setRestaurentList]= useState([]);
...
let [filter,setFilter]=useState({meal_type:meal_id});
  ...
  let filterOpration = async(filter)=>{
   ...
   if(data.status===true){
    setRestaurentList([...data.newResult]);
   }
        ...
        <div className="col-12 d-flex flex-wrap px-lg-5 px-md-5 pt-4">
          <div className="food-shadow col-12 col-lg-3 col-md-4 me-5 p-3 mb-4">
            ...
            <div className="collapse show" id="collapseFilter">
              ...
              <div>
                <div className="ms-1">
                  <input type="radio" name="cost"className="form-check-input" 
                  value="0-500"
                  onChange={(event)=> makeFiltration(event,'cost')}
                  />
                  <label htmlFor="" className="form-check-label ms-1">
                    less then 500
                  </label>
              ...
              <div>
                <div className="ms-1 form-check">
                  <input type="radio" name="sort" className="form-check-input" value="1"
          ...
          <div className="col-12 col-lg-8 col-md-7">
            ...
            >
              ...
              <div className="d-flex">
                ...
                <div className="ms-5">
                  <p className="m-0 fw-bold">{restaurant.cuisine.reduce((pValue,cValue)=>{
                    return( 
                   pValue.name +', '+ cValue.name
                    );
                  })}</p>
